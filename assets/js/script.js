...
var taskFormHandler = function(event) {
    ...
    //has edit attribute, so get task id and call function to complete edit process
    if (isEdit) {
...
var createTaskActions = function(taskId) {
    ...
    for (var i = 0; i < statusChoices.length; i++) {
        ...
        //append to select
        statusSelect.appendChild(statusOptionEl);
    }

    actionContainerEl.appendChild(statusSelect);
...
var completeEditTask = function(taskName, taskType, taskId) {
    ...
    //loop through tasks array and ask object with new content
    for (var i = 0; i < tasks.length; i++) {
        if (tasks[i].id === parseInt(taskId)) {
...
var taskStatusChangeHandler = function(event) {
    ...
    //loop through tasks array and add object with new content
    for (var i = 0; i < tasks.length; i++) {
        if (tasks[i].id === parseInt(taskId)) {
